        ...
        <HoverCard.Root openDelay={200}>
            <HoverCard.Trigger asChild>
                <a
                    ...
                    className="group relative block bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden border border-gray-100 hover:border-blue-300"
                >
                    <div className="relative h-48">
                        <img
                            src={article.coverImage ?? 'https://picsum.photos/seed/tour-${tour.id}/400/300'}
                            alt={article.title}
